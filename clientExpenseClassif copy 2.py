...
with open('/Users/sishirsirugudi/MK Intern Stuff/lloydsStatementJSON.json', "r") as file:
    data = json.load(file)  
...
with open('/Users/sishirsirugudi/MK Intern Stuff/lloydsStatementClassifiedExpense.txt', "w") as file:
